...
public class SoundPlayer {
    ...
    public static void init() {
        musics.put(Asset.GAME_SOUND, (Music) Asset.instance().get(Asset.GAME_SOUND));
        musics.put(Asset.GAME_OVER_SOUND, (Music) Asset.instance().get(Asset.GAME_OVER_SOUND));
        sounds.put(Asset.GAME_OVER_SOUND1, (Sound) Asset.instance().get(Asset.GAME_OVER_SOUND1));
